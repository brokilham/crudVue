        ...
        <div class="content">
            ...
            <form class="login-form" action="{{ route('login') }}" method="POST">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control form-control-solid placeholder-no-fix" id = "email" name="email" type="email" autocomplete="off" placeholder="Email"  /> </div>
                <div class="form-group">
                    <label class="control-label visible-ie8 visible-ie9">Password</label>
                    <input class="form-control form-control-solid placeholder-no-fix" id = "password" name="password" type="password" autocomplete="off" placeholder="Password"  /> </div>
